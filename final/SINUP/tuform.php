	    ...
	    <label for="email">Email :</label></br>
	     <input type="text" name="email" placeholder="shaini@example.com" /></br></br>
            ...
            <lable for="contact_no">Contact No. :</lable></br>
             <input type="text" id="contact_no" name="contact"></br></br>
	                ...
	                <label>Institute Owner</label>            
				          <input type = "radio"
	                       ...
	                       <lable for="street_no">Street No :</lable></br>
	                         <input type="text" name="street" placeholder="112-E" /></br>
	                         ...
	                         <input type="text" name="state" placeholder="MP" /></br>
	                          ...
	                          <button class="submit" name="fk" type="submit">Submit Form </button>
...
$sql = "INSERT INTO t_info(email,OWNER_NAME,contact_no,inst_type,street,area,city,state,pincode,experience) VALUES ('".$_POST["email"]."','".$_POST["name"]."','".$_POST["contact"]."','".$_POST["radSize"]."','".$_POST["street"]."','".$_POST["area"]."','".$_POST["city"]."','".$_POST["state"]."','".$_POST["pin"]."','NULL')";
